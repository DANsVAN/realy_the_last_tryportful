...
export default function Projects({ img, url }) {
  ...
  if (img == "") {
    ...
    return (
      <div className="rounded-lg h-24 w-24 sm:h-36 sm:w-36 md:h-36 md:w-36 lg:w-48 lg:h-48 xl:h-64 xl:w-64 2xl:h-80 2xl:w-80 justify-self-auto z-auto">
        <Link
        ...
        >
          <Image
            ...
            width={1536}
            height={1536}
            className="object-fit-cover rounded-lg border border-slate-500"
          />
        </Link>
      </div>
    );
