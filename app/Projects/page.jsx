...
export default function page1() {
  return (
    <div className=" grid h-screen items-center justify-items-center grid-flow-row grid-cols-3 place-content-center justify-center my-4 sm:my-6 md:my-12 lg:my-32 xl:my-80 gap-32 mx-24 sm:mx-32 md:mx-48 lg:mx-64 lg:gap-x-64 xl:mx-80 2xl:mx-96">
      <Projects
        img={cardGame}
