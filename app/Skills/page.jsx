...
export default function page1() {
  return (
    <div className=" grid items-center justify-items-center grid-flow-row grid-cols-3 place-content-center justify-center my-4 sm:my-6 md:my-12 lg:my-32 xl:my-80 gap-20 mx-24 sm:mx-32 md:mx-48 lg:mx-64 xl:mx-80 2xl:mx-96 ">
